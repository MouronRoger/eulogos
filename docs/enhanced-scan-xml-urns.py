...
def parse_arguments():
    ...
    parser.add_argument(
        '--stats-only', action='store_true', help='Only generate corpus statistics without texts'
    )
    parser.add_argument(
        '--include-content-sample', action='store_true', 
...
def process_work_cts(cts_path: str, xml_files: List[str], work_dir: str, 
                    catalog: Dict[str, Any], author_id: str, work_id: str):
    """
...
def process_text_version(element: ET.Element, version_type: str, xml_files: List[str], 
                         work_dir: str, catalog: Dict[str, Any], author_id: str, work_id: str):
    """
