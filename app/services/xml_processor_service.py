...
class XMLProcessorService:
    ...
    def get_file_path(self, urn: str) -> Path:
        ...
        if not parsed["namespace"] or not parsed["textgroup"] or not parsed["work"] or not parsed["version"]:
            raise ValueError(f"Invalid URN format: {urn}")
        
        # Construct file path
        return self.data_path / parsed["namespace"] / parsed["textgroup"] / parsed["work"] / f"{parsed['textgroup']}.{parsed['work']}.{parsed['version']}.xml"
