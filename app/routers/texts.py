...
async def archive_text(urn: str, archive: bool = True, catalog_service: CatalogService = Depends(get_catalog_service)):
...
async def favorite_text(urn: str, catalog_service: CatalogService = Depends(get_catalog_service)):
